...
│       └── cd.yml                 # CD pipeline (manual deploy)
├── data/
...
1. Check the [SETUP_GUIDE.md](SETUP_GUIDE.md) for local development setup
2. Check the [GITHUB_SETUP.md](GITHUB_SETUP.md) for CI/CD configuration
...
This project implements a complete MLOps pipeline meeting the following milestones:
...
- **Data Versioning:** DVC for datasets, Git LFS for models
...
- **Monitoring:** Prometheus metrics endpoint with custom counters/histograms

For detailed requirement verification, see [ASSIGNMENT_CHECKLIST.md](ASSIGNMENT_CHECKLIST.md).
