...
from src.data.preprocess import load_and_preprocess_image, split_dataset  # noqa: E402

from src.utils.config import IMG_SIZE  # noqa: E402
...
class TestPreprocessing:
    ...
    def test_split_dataset_ratios(self, tmp_path):
        ...
        train_files, val_files, test_files = split_dataset(
            tmp_path, train_ratio=0.8, val_ratio=0.1, test_ratio=0.1
        )
